...
TEST_IMAGES_DIR = BASE / "devtools" / "test_images"
...
async def hud_pill_atlas_rebuild():
    ...
    result = subprocess.run(
        ["python3", str(BASE / "devtools" / "tools" / "build_hud_pill_atlas.py")],
...
BOX_DEFINITIONS_PATH = BASE / "devtools" / "tools" / "box_definitions.json"
...
REGRESSION_RESULTS_PATH = BASE / "devtools" / "tools" / "regression_results.json"
