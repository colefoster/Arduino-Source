...
async function loadRecogResults() {
    ...
    try {
        ...
        if (!recogData.timestamp) {
            status.innerHTML = 'No regression results found. Run <code>python3 devtools/tools/retest.py</code> locally, commit and push <code>devtools/tools/regression_results.json</code>.';
            return;
        }
